...
const LogoutModal = ({ isOpen, onClose, onConfirm }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[60] p-4 transition-opacity duration-300">
      <div className="bg-[#0f1a2e] border border-gray-800 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all p-6 text-center animate-slide-up">
        ...
        <p className="text-gray-400 mb-6 text-sm">Are you sure you want to logout of your account?</p>
